...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Pemasukkan Tambahan</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Pemasukkan" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Pemasukkan</button></a>
          ...
          <?php
            $no=0; 
            $sql="select * FROM pemasukkan_lain";
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_pemasukkan']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="bottom" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-Tambahan.php?&id_pemasukkan=<?php echo  $View['id_pemasukkan']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Tambahan.php",
             type: "GET",
             data : {id_pemasukkan: m,},
...
<!-- TAMBAH PEMASUKKAN TAMBAHAN -->
<!-- Modal Add Pemasukkan Tambahan -->
<?php   
  $ID_PROFIT=1;
  $sql2="select * FROM pemasukkan_lain";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Tambah Pemasukkan <i class="fa fa-pencil"></i></h3>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-Tambahan.php">
                <input type="hidden" name="id_pemasukkan" value=<?php echo $query2; ?>>
                <input type="hidden" name="id_profit" value=<?php echo $ID_PROFIT; ?>> 
                    
                    <div class="form-group">
                      <label for="tgl_masuk" class="labelfrm">Tanggal Pemasukkan</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-calendar"></span></span>
                          <input id="tgl_masuk" class="form-control" type="date" name="tgl_masuk" required="true" autocomplete="off">
                        </div>
                      <label for="keterangan" class="labelfrm">Keterangan</label>
                        <div class="input-group">
                          ...
                          <input id="keterangan" class="form-control" type="text" placeholder="Keterangan" name="keterangan" required="true" autocomplete="off">
                        </div>
                      <label for="jumlah" class="labelfrm">Jumlah</label>
                        <div class="input-group">
                          ...
                          <input id="jumlah" class="form-control" type="text" placeholder="Jumlah" name="jumlah" autocomplete="off" required="true" onkeypress="return mungAngka(event)">
                        </div>
                      <label for="harga" class="labelfrm">Harga</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-money"></span></span>
                          <input id="harga" class="form-control" type="text" placeholder="Harga" name="harga" autocomplete="off" required="true" onkeypress="return mungAngka(event)">
                        </div>
                    </div>
