...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Laporan Produksi</div>
        <div class="card-body">
  ...
  background-color: #005ca7;
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="bottom" title="Cetak Laporan Produksi" href="Det-LapProduksi.php?id_produksi=<?php echo $View['id_produksi']; ?>"><button class="butDetail" id="Edit"><i class="fa fa-print"></i> Print</button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
