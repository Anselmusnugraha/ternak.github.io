...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Modal Kandang</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Modal" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Modal</button></a>
          ...
          <?php 
            $no=0;
            $sql="select * FROM m_kandang ORDER BY tgl_beli DESC";
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="right" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_mkandang']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="right" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-MKandang.php?&id_mkandang=<?php echo  $View['id_mkandang']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Mkandang.php",
             type: "GET",
             data : {id_mkandang: m,},
...
<!-- TAMBAH MODAL KANDANG -->
<!-- Modal Add Modal Kandang -->
<?php   
  $sql2="select * FROM m_kandang";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-Mkandang.php">
                <input type="hidden" name="id_mkandang" value=<?php echo $query2; ?>>
                    ...
                    <div class="form-group">
                      <label for="ket_barang" class="labelfrm">Informasi Barang</label>
                        <div class="input-group">
                          ...
                          <input id="ket_barang" class="form-control" type="text" placeholder="Informasi Barang" name="ket_barang" required="true" autocomplete="off">
                        </div>
                      ...
                      <label for="harga_beli" class="labelfrm">Harga Beli</label>
                        <div class="input-group">
                          ...
                          <input id="harga_beli" class="form-control" type="text" placeholder="Harga Beli" name="harga_beli" required="true" autocomplete="off" onkeypress="return mungAngka(event)">
                        </div>
