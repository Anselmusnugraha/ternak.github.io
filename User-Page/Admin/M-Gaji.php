...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Gaji Karyawan</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Gaji Karyawan" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Gaji Karyawan</button></a>
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select * FROM gj_karyawan";
            $query = mysql_query($sql);
            while ($View=mysql_fetch_array($query)) { 

            $GJ=$View['gaji'];
            $GAJI=number_format($GJ);
            $TGL = $View['tgl_gaji'];
            $ForTGLGaji=date('d-M-Y', strtotime($TGL));          
          ?> 
                <tr>
                  <td><?php echo $View['nama_kry']; ?></td>
                  <td><?php echo $View['alamat']; ?></td>
                  <td><?php echo $View['no_hp']; ?></td>
                  <td><?php echo $View['usia']; ?> Tahun</td>
                  <td>Rp. <?php echo $GAJI; ?></td>
                  <td><?php echo $ForTGLGaji; ?></td>
                  <td><?php echo $View['keterangan']; ?></td>
                  <td>
                    <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_kry']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                <!--    <a href="../../Laporan/Rep-Gaji.php?id_kry=<?php echo $View['id_kry']; ?>"><button class="butDetail" id="Edit"><i class="fa fa-print"></i> Print</button></a> -->
                    <a data-toggle="tooltip" data-placement="bottom" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-GJKry.php?&id_kry=<?php echo  $View['id_kry']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<!-- Modal Add Gaji Karyawan -->
<?php   
  $sql2="select * FROM gj_karyawan";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Tambah Gaji Karyawan <i class="fa fa-pencil"></i></h3>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-GJkry.php">
                <input type="hidden" name="id_kry" value=<?php echo $query2; ?>>
                    ...
                    <div class="form-group">
                      <label for="nama_kry" class="labelfrm">Nama</label>
                        <div class="input-group">
                          ...
                          <input id="nama_kry" class="form-control" type="text" placeholder="Nama" name="nama_kry" required="true" autocomplete="off">
                        </div>
                      <label for="alamat" class="labelfrm">Alamat</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-home"></span></span>
                          <input id="alamat" class="form-control" type="text" placeholder="Alamat" name="alamat" required="true" autocomplete="off">
                        </div>
                      <label for="no_hp" class="labelfrm">No. Hp/Telp.</label>
                        <div class="input-group">
                          ...
                          <input id="no_hp" class="form-control" type="text" placeholder="No. Hp/Telp." name="no_hp" autocomplete="off">
                        </div>
                      <label for="usia" class="labelfrm">Usia</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-user"></span></span>
                          <input id="usia" class="form-control" type="text" placeholder="Usia" name="usia" autocomplete="off">
                        </div>
                      <label for="gaji" class="labelfrm">Gaji</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-money"></span></span>
                          <input id="gaji" class="form-control" type="text" placeholder="Gaji" name="gaji" required="true" autocomplete="off" onkeypress="return mungAngka(event)">
                        </div>
                      <label for="tgl_gaji" class="labelfrm">Tanggal Gaji</label>
                        <div class="input-group">
                          ...
                          <input id="tgl_gaji" class="form-control" type="date" name="tgl_gaji" required="true" autocomplete="off">
                        </div>
