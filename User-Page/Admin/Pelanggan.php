...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Pelanggan/Customer</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Data Pelanggan" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Data Pelanggan</button></a>
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="right" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_customer']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="right" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-Pelanggan.php?&id_customer=<?php echo  $View['id_customer']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Pelanggan.php",
             type: "GET",
             data : {id_customer: m,},
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Tambah Data Pelanggan <i class="fa fa-pencil"></i></h3>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-Pelanggan.php">
                <input type="hidden" name="id_customer" value=<?php echo $query2; ?>>
                    ...
                    <div class="form-group">
                      ...
                      <label for="no_telp" class="labelfrm">No. Hp/Telp.</label>
                        <div class="input-group">
                          ...
                          <input id="no_telp" class="form-control" type="text" placeholder="No. Hp/Telp." name="no_telp" autocomplete="off">
                        </div>
                      <label for="email" class="labelfrm">E-mail</label>
                        <div class="input-group">
                          ...
                          <input id="email" class="form-control" type="text" placeholder="E-mail" name="email" autocomplete="off">
                        </div>
