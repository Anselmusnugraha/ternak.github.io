...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a data-toggle="tooltip" data-placement="bottom" title="Halaman Utama Data User" href="User.php">User</a>
        </li>
...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data User Aplikasi</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah User" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah User</button></a>
          ...
          ?> 
                <tr>
                  ...
                  <td><?php if ($View['hak_akses']==0) {
                              echo "Admin";
                            }else{
                              echo "User Tambahan";
                              } ?></td>
                  <td>
                    <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="#"  <?php if ($View['username']=='Admin') { ?> disabled <?php }elseif ($View['password']=='Admin'){ ?>disabled <?php }else{?> class='OpenModal' <?php } ?> id='<?php echo $View['id_user']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="bottom" title="Hapus" href="#" <?php if ($View['username']=='Admin') { ?> disabled <?php }elseif ($View['password']=='Admin'){ ?>disabled <?php }else{?> onclick="confirm_modal('DELETE/delete-User.php?&id_user=<?php echo  $View['id_user']; ?>');" <?php } ?> ><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Tambah User <i class="fa fa-user"></i></h3>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-User.php">
                    ...
                    <div class="form-group">
                      ...
                      <label for="password" class="labelfrm">Password</label>
                        <div class="input-group">
                          ...
                          <input id="password" class="form-control" type="text" placeholder="Password" name="password" required="true" autocomplete="off">
                        </div>
                      ...
                      <label for="hak_akses" class="labelfrm">Hak Akses</label>
                        <div class="input-group">
                          ...
                          <select class="form-control" name="hak_akses" id="hak_akses" required="true">
                                  <option value="" selected="selected">-- Pilih Hak Akses --</option>
                                  <option value="0">Admin</option>
                                  <option value="1">User Tambahan</option>
                          </select>
                        </div>
                    </div>
