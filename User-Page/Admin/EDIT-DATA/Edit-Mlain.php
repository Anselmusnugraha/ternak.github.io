...
<?php
  $ID_ML = $_GET['id_mlain'];
  $sql = "select * from m_lain where id_mlain='$ID_ML'";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Edit Modal Lain-lain <i class="fa fa-edit"></i></h3>
            ...
            <!-- Modal Body --> 
                <div class="modal-body">
                    <p class="statusMsg"></p> 
                <form id="FormValidation" method="post" action="EDIT-DATA/Controller-Edit/Proses-Edit-Mlain.php">
                <input type="hidden" name="id_mlain" value="<?php echo $ID_ML; ?>">
                <input type="hidden" name="total_MODAL" value="<?php echo $View['total_Mlain']; ?>">

                    <div class="form-group">
                      <label for="ket_barang" class="labelfrm">Keterangan Barang</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-font"></span></span>
                          <input id="ket_barang" class="form-control" type="text" placeholder="Keterangan Barang" name="ket_barang" required="true" autocomplete="off"  value="<?php echo $View['ket_barang']; ?>">
                        </div>
