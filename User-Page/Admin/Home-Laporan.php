...
<!-- End Breadcrumbs-->
<div class="row">
<a data-toggle="tooltip" data-placement="bottom" title="Laporan Pengeluaran dan Modal" href="Lap-Keluar.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Laporan Pengeluaran (Modal)</h4>
      <img src="../../Image/Report-modal.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Laporan Penjualan Telur" href="Lap-Penjualan.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Laporan Penjualan Telur</h4>
      <img src="../../Image/Report-penjualan.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Laporan Produksi Telur" href="Lap-Produksi.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Laporan Produksi Telur</h4>
      <img src="../../Image/Report-produksi.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Laporan Keuntungan (Profit)" href="Lap-Profit.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Laporan Profit</h4>
      <img src="../../Image/Balance.png" class="menu">
    </div>
  </button></a>
</div>
    <!-- /.container-fluid-->
