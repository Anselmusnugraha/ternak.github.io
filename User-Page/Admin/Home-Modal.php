...
<!-- End Breadcrumbs-->
<div class="row">
<a data-toggle="tooltip" data-placement="bottom" title="Modal untuk Kandang" href="M-Kandang.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Modal Kandang</h4>
      <img src="../../Image/Pabrik.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Modal untuk Bibit Bebek" href="M-Bibit.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Modal Bibit</h4>
      <img src="../../Image/bebek.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Modal untuk Pakan dan Konsentrat" href="M-Pakan.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Modal Pakan</h4>
      <img src="../../Image/Karung.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Modal Tambahan, Vitamin dll" href="M-Other.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Modal Lain-lain</h4>
      <img src="../../Image/Other.png" class="menu">
    </div>
  </button></a>
<a data-toggle="tooltip" data-placement="bottom" title="Gaji Karyawan" href="M-Gaji.php">
  <button class="setingButt"> 
    <div class="container-fluid">
      <h4>Gaji Karyawan</h4>
      <img src="../../Image/Gaji.png" class="menu">
    </div>
  </button></a>
</div>
    <!-- /.container-fluid-->
