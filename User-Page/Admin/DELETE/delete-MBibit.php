...
$ID_BIBIT=$_GET['id_mbibit'];

$sql="select * from m_bibit where id_mbibit='$ID_BIBIT'";
$query=mysql_query($sql);
$Tampil=mysql_fetch_array($query);
$TOTAL_MODAL=$Tampil['total_Mbibit'];
...
$sql2="delete from m_bibit where id_mbibit='$ID_BIBIT'";
