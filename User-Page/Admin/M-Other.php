...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Modal Lain-lain</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Modal" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Modal</button></a>
          ...
          ?> 
                <tr>
                  ...
                  <td><?php echo $View['ket_barang']; ?></td>
                  <td><?php echo $View['jumlah']; ?></td>
                  <td>Rp. <?php echo $HargaBeli; ?></td>
                  <td><?php echo $View['keterangan']; ?></td>
                  <td>Rp. <?php echo $TotalModal; ?></td>
                  <td>
                    <a data-toggle="tooltip" data-placement="right" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_mlain']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="right" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-MLain.php?&id_mlain=<?php echo  $View['id_mlain']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<!-- TAMBAH MODAL LAIN -->
<!-- Modal Add Modal Lain -->
<?php   
  $sql2="select * FROM m_lain";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-Mlain.php">
                <input type="hidden" name="id_mlain" value=<?php echo $query2; ?>>
                    
                    <div class="form-group">
                      <label for="nama" class="labelfrm">Keterangan Barang</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-font"></span></span>
                          <input id="ket_barang" class="form-control" type="text" placeholder="Keterangan Barang" name="ket_barang" required="true" autocomplete="off">
                        </div>
                      <label for="jumlah" class="labelfrm">Jumlah</label>
                        <div class="input-group">
                          ...
                          <input id="jumlah" class="form-control" type="text" placeholder="Jumlah" name="jumlah" required="true" autocomplete="off" onkeypress="return mungAngka(event)">
                        </div>
                      <label for="harga_beli" class="labelfrm">Harga</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-money"></span></span>
                          <input id="harga_beli" class="form-control" type="text" placeholder="Harga" name="harga_beli" required="true" autocomplete="off" onkeypress="return mungAngka(event)">
                        </div>
                      <label for="tgl_beli" class="labelfrm">Tanggal (Beli)</label>
                        <div class="input-group">
                          ...
                          <input id="tgl_beli" class="form-control" type="date" name="tgl_beli" required="true" autocomplete="off">
                        </div>
