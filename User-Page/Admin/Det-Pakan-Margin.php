...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Detail Penghitungan Harga Pakan</div>
        <div class="card-body">
...
<?php
  $sql="select * FROM hit_pakan where id_pakan='$ID_PAKAN'";
  $query=mysql_query($sql);
  while ($View=mysql_fetch_array($query)) {
?>
<h2><b><?php echo $View['Nama']; }?></b></h2>

            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0"> 
              <tbody>
          <?php 
            $sql1="select * FROM hit_pakan where id_pakan='$ID_PAKAN'";
            ...
            $HRG_PJ=$View1['hrg_pj'];
            $HargaPJ=number_format($HRG_PJ);

            $HRG_KONS=$View1['hrg_kons'];
            $HargaKonsentrat=number_format($HRG_KONS);

            $HRG_GOGIK=$View1['hrg_tmb1'];
            $HargaGogik=number_format($HRG_GOGIK);

            $HRG_TMB=$View1['hrg_tmb2'];
            $HargaTambahan=number_format($HRG_TMB);
          
          ?> 
                <tr>
                  <td><b>Populasi Bebek</b></td>
                  <td>: <?php echo $View1['Populasi']; ?> Ekor</td>
                </tr>
                <tr>
                  <td><b>Kebutuhan Pakan</b></td>
                  <td>: <?php echo $View1['Keb_pakan']; ?> Kg</td>
                </tr>
                <tr>
                  <td colspan="2" align="center" style="background: #4c5256"><b>PJ/KATUL</b></td>
                </tr>
                <tr>
                  <td><b>Harga/Kg</b></td>
                  <td>: Rp. <?php echo $HargaPJ; ?></td>
                </tr>
                <tr>
                  <td><b>Komposisi Campuran (%)</b></td>
                  <td>: <?php echo $View1['komp_pj']; ?> %</td>
                </tr>
                <tr>
                  <td colspan="2" align="center" style="background: #4c5256"><b>KONSENTRAT</b></td>
                </tr>
                <tr>
                  <td><b>Harga/Kg</b></td>
                  <td>: Rp. <?php echo $HargaKonsentrat; ?></td>
                </tr>
                <tr>
                  <td><b>Komposisi Campuran (%)</b></td>
                  <td>: <?php echo $View1['komp_kons']; ?> %</td>
                </tr>
                <tr>
                  <td colspan="2" align="center" style="background: #4c5256"><b>GOGIK/AKING</b></td>
                </tr>
                <tr>
                  <td><b>Harga/Kg</b></td>
                  <td>: Rp. <?php echo $HargaGogik; ?></td>
                </tr>
                <tr>
                  <td><b>Komposisi Campuran (Kg)</b></td>
                  <td>: <?php echo $View1['komp_tmb1']; ?> Kg</td>
                </tr>
                <tr>
                  <td colspan="2" align="center" style="background: #4c5256"><b>PAKAN TAMBAHAN</b></td>
                </tr>
                <tr>
                  <td><b>Harga/Kg</b></td>
                  <td>: Rp. <?php echo $HargaTambahan; ?></td>
                </tr>
                <tr>
                  <td><b>Komposisi Campuran (Kg)</b></td>
                  <td>: <?php echo $View1['komp_tmb2']; ?> Kg</td>
                </tr>
                <tr>
                  <td>Harga Campuran Pakan dari Populasi <b><?php echo $View1['Populasi']; ?> Ekor</b> dengan Kebutuhan Pakan <b><?php echo $View1['Keb_pakan']; ?> Kg</b> diperoleh</td>
                  <td><h3><b>: Rp. <?php echo $HargaPakan; ?> /Kg</b></h3></td>
                </tr>
                <tr>
                  <td colspan="2" align="center" style="background: #4c5256"><b>CATATAN</b></td>
                </tr>
                <tr>
                  <td colspan="2" align="left"><?php echo $View1['catatan']; ?></td>
                </tr>
            <?php } ?>  
              </tbody>
            </table>
