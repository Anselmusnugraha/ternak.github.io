...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Laporan Pengeluaran (Modal)</div>
        <div class="card-body">
...
-webkit-transform:scale(1.1);
  ...
  background-color: #005ca7;
                ...
                <form id="FormValidation" method="post" action="Lap-Keluar.php">
...
?>
<a data-toggle="tooltip" data-placement="bottom" title="Klik untuk Mencetak" href="../../Laporan/Rep-Modal.php?awal=<?php echo $tanggal_awal; ?>&akhir=<?php echo $tanggal_akhir; ?>"><button class="AddSkh"><i class="fa fa-print"></i> Print Laporan Modal</button></a>
<?php 
    $sql1="select SUM(total_Mpakan) AS tot_kabeh_Mpakan  FROM m_pakan where tgl_beli between '$tanggal_awal' and '$tanggal_akhir'";
    $query1 = mysql_query($sql1);
    $View1=mysql_fetch_array($query1);
      $sql2="select SUM(total_Mlain) AS tot_kabeh_Mlain  FROM m_lain where tgl_beli between '$tanggal_awal' and '$tanggal_akhir'";
      $query2 = mysql_query($sql2);
      $View2=mysql_fetch_array($query2);

      $TOT_MPAKAN=$View1['tot_kabeh_Mpakan'];
      $TOT_MLAIN=$View2['tot_kabeh_Mlain'];
