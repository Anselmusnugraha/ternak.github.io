...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Modal Pakan</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Modal" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Modal</button></a>
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="right" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_mpakan']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="right" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-MPakan.php?&id_mpakan=<?php echo  $View['id_mpakan']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<!-- TAMBAH MODAL PAKAN -->
<!-- Modal Add Modal Pakan -->
<?php   
  $sql2="select * FROM m_pakan";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-Mpakan.php">
                <input type="hidden" name="id_mpakan" value=<?php echo $query2; ?>>
                    ...
                    <div class="form-group">
                      ...
                      <label for="harga" class="labelfrm">Harga</label>
                        <div class="input-group">
                          ...
                          <input id="harga" class="form-control" type="text" placeholder="Harga" name="harga" required="true" autocomplete="off" onkeypress="return mungAngka(event)">
                        </div>
