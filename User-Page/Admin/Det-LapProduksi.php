  ...
  <img src="../../image/Logo-DFarm.png" class="Icon">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Data Produksi Telur Bebek">
...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a data-toggle="tooltip" data-placement="bottom" title="Halaman Utama Laporan Produksi Telur" href="Lap-Produksi.php">Laporan Produksi</a>
        </li>
...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Detail Laporan Produksi</div>
        <div class="card-body">
...
-webkit-transform:scale(1.1);
  ...
  background-color: #005ca7;
                ...
                <form id="FormValidation" method="post" action="Det-LapProduksi.php?id_produksi=<?php echo $ID_PRODUKSI; ?>">
...
?>
<a data-toggle="tooltip" data-placement="bottom" title="Klik untuk Mencetak" href="../../Laporan/Rep-Produksi.php?awal=<?php echo $tanggal_awal; ?>&akhir=<?php echo $tanggal_akhir; ?>&id_produksi=<?php echo $ID_PRODUKSI; ?>"><button class="AddSkh"><i class="fa fa-print"></i> Print Laporan Produksi</button></a>
<?php 
  $sql0="select * from produksi where id_produksi='$ID_PRODUKSI'";
  $query0=mysql_query($sql0);
  $lihat=mysql_fetch_array($query0);

    $sql2="select SUM(jumlah_produksi) AS jum_prod  FROM det_produksi where tgl_produksi between '$tanggal_awal' and '$tanggal_akhir' and id_produksi='$ID_PRODUKSI'";
    $query2 = mysql_query($sql2);
    $View2=mysql_fetch_array($query2);
    
    $sql3="select AVG(jumlah_produksi) AS rata_prod  FROM det_produksi where tgl_produksi between '$tanggal_awal' and '$tanggal_akhir' and id_produksi='$ID_PRODUKSI'";
    $query3 = mysql_query($sql3);
    $View3=mysql_fetch_array($query3);

    $RATA_PROD=$View3['rata_prod'];
    $AVG_RATA=round($RATA_PROD);
?>
<h4><b>Produksi Telur:</b> <?php echo $lihat['kandang']; ?></h4>
<h6>Total Produksi Telur dari tanggal <i><?php echo $ForTglAWAL; ?></i> sampai tanggal <i><?php echo $ForTglAKHIR; ?></i> : <b><?php echo $TOT_PRO=$View2['jum_prod']; ?> Butir</b></h6>
<h6>Rata-rata Produksi Telur dari tanggal <i><?php echo $ForTglAWAL; ?></i> sampai tanggal <i><?php echo $ForTglAKHIR; ?></i> : <b><?php echo $AVG_RATA; ?> Butir</b></h6>
            ...
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql1="select * FROM det_produksi WHERE tgl_produksi BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND id_produksi='$ID_PRODUKSI'";
            $query1 = mysql_query($sql1);
            while ($View1=mysql_fetch_array($query1)) { 

            $TGL = $View1['tgl_produksi'];
            $ForTGLProd=date('d-M-Y', strtotime($TGL));        
          ?> 
                <tr>
                  <td><?php echo $ForTGLProd;?></td>
                  <td><?php echo $View1['jumlah_produksi']; ?> Butir</td>
