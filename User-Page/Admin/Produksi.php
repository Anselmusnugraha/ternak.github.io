...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-text-o"></i> Data Produksi Telur</div>
        <div class="card-body">
...
<a data-toggle="tooltip" data-placement="bottom" title="Menambah Data Produksi" href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddMDL"><i class="fa fa-plus"></i> Tambah Data Produksi</button></a>
          ...
          <?php 
            ...
            $TGL = $View['tgl_masuk_kandang'];
            $ForTGLMasuk=date('d-M-Y', strtotime($TGL));          
          ?> 
                <tr>
                  <td><?php echo $no; ?></td>
                  <td><?php echo $View['kandang']; ?></td>
                  <td><?php echo $ForTGLMasuk; ?></td>
                  <td><?php echo $View['total_produksi']; ?> Butir</td>
                  <td><?php echo $View['rata_produksi']; ?> Butir</td>
                  <td><?php echo $View['keterangan']; ?></td>
                  <td>
                    <a data-toggle="tooltip" data-placement="bottom" title="Input Produksi" href="Det-Produksi.php?id_produksi=<?php echo $View['id_produksi']; ?>"><button class="butDetail" id="Edit"><i class="fa fa-list-alt"></i></button></a>
                    <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="#" class='OpenModal' id='<?php echo $View['id_produksi']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a data-toggle="tooltip" data-placement="bottom" title="Hapus" href="#" onclick="confirm_modal('DELETE/delete-Produksi.php?&id_produksi=<?php echo  $View['id_produksi']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Produksi.php",
             type: "GET",
             data : {id_produksi: m,},
...
<!-- Modal Add Produksi Telur -->
<?php   
  $sql2="select * FROM produksi";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Tambah Data Produksi <i class="fa fa-pencil"></i></h3>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Save-Produksi.php">
                <input type="hidden" name="id_produksi" value=<?php echo $query2; ?>>
                    ...
                    <div class="form-group">
                      <label for="kandang" class="labelfrm">Kandang</label>
                        <div class="input-group">
                          ...
                          <input id="kandang" class="form-control" type="text" placeholder="Kandang" name="kandang" required="true" autocomplete="off">
                        </div>
                      <label for="tgl_masuk_kandang" class="labelfrm">Tanggal (Masuk)</label>
                        <div class="input-group">
                          ...
                          <input id="tgl_masuk_kandang" class="form-control" type="date" name="tgl_masuk_kandang" required="true" autocomplete="off">
                        </div>
