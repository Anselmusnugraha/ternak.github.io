...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-cart-plus"></i> Laporan Pembelian Bahan Pakan</div>
        <div class="card-body">
...
<a href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddBahan"> Cetak Berdasarkan Tanggal <i class="fa fa-print"></i></button></a>
          ...
          <?php 
            ...
            $sql="select * from pembelian_bhnpkn";
            $query = mysql_query($sql);
            while ($View=mysql_fetch_array($query)) {
              $NO_BL = $View['no_pembelian'];
              $TGL = $View['tgl_pembelian'];
          ...
          ?> 
                <tr>
                  <td><?php echo $View['no_pembelian']; ?></td>
                  <td><?php echo $ForTGLBeli; ?></td>
                  <td>Rp. <?php echo $Total; ?></td>
                  <td>
                    <a href="DetPembelian.php?no_pembelian=<?php echo $View['no_pembelian'];?>"><button class="butDetail"><i class="fa fa-list-alt"></i></button></a>
                    <a href="../../Laporan/Rep-Pembelian.php?no_pembelian=<?php echo $View['no_pembelian'];?>"><button class="butPrint"><i class="fa fa-print"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="../../Laporan/Rep-PembelianBT.php">
