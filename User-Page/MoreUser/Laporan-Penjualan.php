...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file-cart-plus"></i> Laporan Penjualan Telur</div>
        <div class="card-body">
...
<a href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddBahan"> Cetak Berdasarkan Tanggal <i class="fa fa-print"></i></button></a>
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select penjualan_telur.*, pakan.nama_pakan FROM pakan inner join produksi_telur on pakan.id_pakan=produksi_telur.id_pakan inner join penjualan_telur on produksi_telur.id_produksi=penjualan_telur.id_produksi";
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a href="DetPenjualan.php?id_penjualan=<?php echo $View['id_penjualan']; ?>"><button class='butDetail' id='Edit'><i class='fa fa-list-alt'></i></button></a>
                    <a href="../../Laporan/Rep-Penjualan.php?id_penjualan=<?php echo $View['id_penjualan'];?>"><button class="butPrint"><i class="fa fa-print"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="../../Laporan/Rep-PenjualanBT.php">
